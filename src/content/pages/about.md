...
Recorded from a live Zoom training series I ran during the lockdown for more than 500 participants, so people could use that time to learn a real skill and earn with it. The material still holds; it is on [YouTube](https://www.youtube.com/@pravkarki), alongside recorded front-end and design lectures and workshops, such as [Learn how to install Git, VS Code and the GitHub Student Developer Pack](https://www.youtube.com/watch?v=Jisn10XJbhI).
